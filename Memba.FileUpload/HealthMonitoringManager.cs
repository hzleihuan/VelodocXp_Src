...
namespace Memba.FileUpload
{
    ...
    internal static class HealthMonitoringManager
    {
        ...
        public const string DefaultSource = "File Upload";
        ...
        /// <param name="e"></param>
        public static void LogErrorEvent(string msg, UploadData data, int eventCode, Exception e)
        {
            if (HealthMonitoringManager.Enabled)
            {
                UploadRequestErrorEvent objUploadRequestErrorEvent = new UploadRequestErrorEvent(msg, data, eventCode, e);
                objUploadRequestErrorEvent.Raise();
            }
            else
            {
                try
