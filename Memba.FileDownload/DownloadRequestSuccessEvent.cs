...
{
    internal class DownloadRequestSuccessEvent : WebRequestEvent
    {
        public const int RuntimeDownloadSuccessCodeBase = WebEventCodes.WebExtendedBase + 54000;
        public const int RuntimeDownloadSuccessCompleted = RuntimeDownloadSuccessCodeBase + 1;
        ...
        public DownloadRequestSuccessEvent(string msg, object eventSource, int eventCode)
        ...
        /// <param name="e">The Exception associated with the error.</param>
        public DownloadRequestSuccessEvent(string msg, object eventSource, int eventCode, int detailedCode)
